    ...
    <section id="pricing" className="relative z-10 py-16 md:py-20 lg:py-28">
      <div className="container">
        <SectionTitle
          ...
          paragraph="Unveiling compelling packages and adaptable payment avenues to give you the ultimate edge. "
          center
          width="665px"
        />
